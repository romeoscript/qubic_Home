    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          <Topic>
            <Circle />
            <span>We Make Businesses Go Digital</span>
          </Topic>
          <Title>If We Didn’t Build It, Question It.</Title>
          <SubText>
            we help fast growing companies build award winning Product
            Technology Solution.
          </SubText>
          <a href="mailto:ohmar@qubic.com.ng" style={{color:'rgb(0, 122, 255)'}}>
          <CTA>
              Get in touch &nbsp;
